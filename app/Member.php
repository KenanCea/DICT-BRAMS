...
class Member extends Model
{
    ...
    'previousResidence','no_of_months_and_year_living_in_this_brgy','reason_you_left_in_previous_brgy','reason_you_came_in_this_brgy','until_when_you_stay_in_this_brgy','who_accompanied_you_to_transfer_here','barangay_id'
    ];
}

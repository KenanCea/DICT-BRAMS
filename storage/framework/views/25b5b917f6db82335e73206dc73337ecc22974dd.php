            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link p-1" data-toggle="dropdown" href="#">
                        ...
                        <div class="image"><img src="/img/profile/<?php echo e(Auth::user()->photo); ?>" alt="Logo"></div>
                        </div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right"> <a href="#" class="dropdown-item"> <i class="fas fa-circle green mr-2"></i> <?php echo e(Auth::user()->name); ?> </a>
                        <div class="dropdown-divider"></div>
                        ...
                        <a class="dropdown-item" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"> <i class="fas fa-sign-out-alt mr-2"></i> <?php echo e(__('Logout')); ?> </a>

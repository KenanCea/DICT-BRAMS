...
$factory->define(Household::class, function (Faker $faker) {
    return [
        ...
        'house_no' => $faker->unique(true)->randomDigitNotNull,
        ...
        'means_of_transportation' =>$faker->randomElement(['PU jeep', ' Taxi', 'Tricycle', 'PU bus', 'Private car','others']),
        'means_of_transportation_others' =>$faker->sentence(10),
    ];
});

          ...
          <v-card-text>
            <v-container grid-list-md>
              <v-layout wrap>
                ...
                <v-flex xs12 sm6>
                  <v-text-field v-model="inhabitantForm.weight" mask="###" label="Weight(kg)" required></v-text-field>
                </v-flex>
                <v-flex xs12 sm6>
                  <v-text-field v-model="inhabitantForm.height" mask="###" label="Height(cm)" required></v-text-field>
                </v-flex>
                <v-flex xs12 sm6>
                  <v-select

<template>
  <div style="min-width:auto; max-width:auto">
...
export default {
  ...
  methods: {
    ...
    word() {
      ...
      var converted = htmlDocx.asBlob(html.innerHTML, {
    ...
    pdf() {
      ...
      doc.text(
        this.reportshHeader.name + "-" + this.reportshHeader.province,
        width,
        98.5,
        "center"
      );
